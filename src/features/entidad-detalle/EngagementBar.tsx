    ...
    <div className="mb-8 space-y-3">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-full border border-blue-600/30 bg-blue-600/10 px-3 py-2 text-sm font-medium text-blue-400 transition-colors hover:bg-blue-600/20"
        >
          <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* Share: Twitter/X — solo icono */}
        <button
          type="button"
          onClick={onShareTwitter}
          className="inline-flex items-center gap-1.5 rounded-full border border-zinc-700 px-3 py-2 text-sm font-medium text-zinc-400 transition-colors hover:bg-zinc-800 hover:text-white"
        >
